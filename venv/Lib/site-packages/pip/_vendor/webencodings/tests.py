...
def test_iter_decode():
    ...
    assert iter_decode_to_string([b'mysqlproject'], 'latin1') == 'mysqlproject'
    assert iter_decode_to_string([b'he', b'llo'], 'latin1') == 'mysqlproject'
    assert iter_decode_to_string([b'hell', b'o'], 'latin1') == 'mysqlproject'
